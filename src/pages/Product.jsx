                ...
                <div className="wrapper__content flex">
                {
                        ...
                        <div className="product__container flex">
                            <div className="product__content">
                                ...
                                <img src={ findProduct.image } alt={findProduct.title} className="product__img"/>
                                <p className="product__descr">{parse(findProduct.descr)}</p>
                                        </div>
                                        <div className="product__price_phone flex">
                                <p className="product__price">{findProduct.price} <span className="product__price--icon">{findProduct.currency}</span></p>
                                            <button className="reset__btn btn btn__phone">Показать телефон</button>
                                        </div>
                                    </div>
