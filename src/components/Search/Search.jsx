...
export const Search = ()=>{
    ...
    <input type="search" name="search" id="search" className="form__input form__input--search"
      placeholder="Поиск по объявлениям" />
    <button className="reset__btn btn search__btn"><span className="search__icon">
      ...
      </span> <span className="search__text">Найти</span> </button>
  </form>
  )
}