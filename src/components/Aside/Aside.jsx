...
export const Aside = () =>{
  return(
    ...
    <h2 className="section__subtitle">Сервисы и услуги</h2>
    <ul className="list__reset list__services flex">
      <li className="services__item">
        <article className="services__card">
          ...
          <h3 className="services__title">Доставка</h3>
          <p className="services__descr">Проверка при получении и возможность бесплатно вернуть товар</p>
        </article>
      </li>
      <li className="services__item">
        <article className="services__card">
          <span className="services__icon"><svg width="30.000000" height="30.000000" viewBox="0 0 30 30" fill="none"
              xmlns="http://www.w3.org/2000/svg" >
          ...
          <h3 className="services__title">Автотека</h3>
          <p className="services__descr">Отчёт с историей авто: пробег, владельцы, сведения о залоге, ДТП и ремонтах
          </p>
        </article>
      </li>
      <li className="services__item">
        <article className="services__card">
          ...
          <h3 className="services__title">Онлайн-бронирование жилья</h3>
          <p className="services__descr">Посуточная аренда квартир и домов: большой выбор вариантов для поездок по
            России</p>
        </article>
      </li>
    </ul>
    <footer className="footer__aside flex">
      <p className="footer__copy">&copy; ООО «Абито», 2011–2021</p>
      <a href="#!" className="link__aside link">Политика конфиденциальности</a>
      <a href="#!" className="link__aside link">Обработка данных</a>
    </footer>
  </aside>
  )
}